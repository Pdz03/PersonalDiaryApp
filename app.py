...
password = 'sparta'
cxn_str = f'mongodb+srv://test:{password}@cluster0.9xken9a.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp'
...
def main():
    ...
    errword = request.args.get('errword')
